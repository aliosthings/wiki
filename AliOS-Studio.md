# 目录
- [下载地址](#1-下载安装)
    - [VS Code安装](#11-vs-code安装)
    - [AliOS Studio安装](#12-alios-studio安装)
- [界面介绍](#2-界面介绍)
- [VS Code介绍](#3-vs-code介绍)
    - [c语言支持](#31-c语言支持)
    - [命令面板与符号搜索](#32-命令面板与符号搜索)
    - [keymap映射](#33-keymap映射)
    - [符号视图](#34-符号视图)
    - [git支持](#35-git支持)
    - [内置终端](#36-内置终端) 
- [新建与导入项目](#4-新建与导入项目)
...
- [编译功能](#6-编译功能)
- [烧写功能](#7-烧写功能)
    - [串口烧写](#71-串口烧写-mk3060为例)
    - [J-LINK烧写](#72-j-link烧写-mk3060为例)
- [aos-cube支持](#8-aos-cube支持)
- [单步调试](#9-单步调试)
- [Mesh调试](#10-mesh调试)
- [Trace](#11-trace)
- [技术支持](#12-技术支持)
