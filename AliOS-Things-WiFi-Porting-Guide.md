...
此外，通过AliOS Things中的Alink测试APP，可以更充分的验证WiFi功能。关于Alink测试和认证，请参考[Alink Smart Config Test and Certification](https://github.com/alibaba/AliOS-Things/wiki/Alink-Smart-Config-Test-and-Certification)