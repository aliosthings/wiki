...
# 2链接脚本ld文件修改  
多bin编译意味着有app bin和kernl bin的编译，这意味着有对应的[app.ld](https://github.com/alibaba/AliOS-Things/blob/master/platform/mcu/beken/linkinfo/bk7231_app.ld)和[kernel.ld](https://github.com/alibaba/AliOS-Things/blob/master/platform/mcu/beken/linkinfo/bk7231_kernel.ld)。(mk3060为例)
