...
# 2链接脚本ld文件修改  
多bin编译意味着有app bin和kernl bin的编译，这意味着有对应的[app.ld](https://github.com/alibaba/AliOS/blob/master/kernel/protocols/net/netif/ethernetif.c)和[kernel.ld](https://github.com/alibaba/AliOS/platform/mcu/beken/linkinfo)。
